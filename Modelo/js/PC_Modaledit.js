...
function saveUser() {
    ...
    fetch('../../Controlador/guardados/PC_guardarusuario.php', {
        method: 'POST',
        headers: {
...
function saveName() {
    ...
    fetch('../../Controlador/guardados/PC_guardarnombre.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function saveEmail() {
    ...
    fetch('../../Controlador/guardados/PC_guardarcorreo.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function savePhone() {
    ...
    if(!REGEX_TELEFONO_VALIDO.test(phone)){
       ...
       fetch('../../Controlador/guardados/PC_guardartelefono.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
function savePassword() {
   ...
   fetch('../../Controlador/guardados/PC_guardarpassword.php', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
