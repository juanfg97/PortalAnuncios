...
<head>
    ...
    <title>Configuración - Portal Residente - La Quinta</title>
...
<body>
                        ...
                        <div class="profile-info">
                            ...
                            <div class="info-item">
                                ...
                                <div class="info-content">
                                    ...
                                    <div class="info-value">Edificio <?php echo $_SESSION['Terraza'].$_SESSION['Edificio'];  ?>- Apartamento <?php   echo $_SESSION['Piso'].$_SESSION['Apartamento'];  ?></div>
                                </div>
   ...
   <!-- Footer -->
    ...
    <script src="../../Modelo/js/Modaledit.js"></script>
</body>
</html>